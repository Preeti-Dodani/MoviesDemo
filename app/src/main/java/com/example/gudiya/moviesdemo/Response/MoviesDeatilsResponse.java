...
import com.example.gudiya.moviesdemo.Model.GenreModel;
import com.example.gudiya.moviesdemo.Model.ProductionCompanyModel;
import com.example.gudiya.moviesdemo.Model.ProductionCountryModel;
import com.example.gudiya.moviesdemo.Model.SpokenlanguageModel;
 ...
 */
public class MoviesDeatilsResponse {
    ...
    @Expose
    private List<ProductionCompanyModel> productionCompanies = new ArrayList<ProductionCompanyModel>();
    @SerializedName("production_countries")
    @Expose
    private List<ProductionCountryModel> productionCountries = new ArrayList<ProductionCountryModel>();
    ...
    @Expose
    private List<SpokenlanguageModel> spokenLanguages = new ArrayList<SpokenlanguageModel>();
